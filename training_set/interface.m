...
for n=1:Ne
   ...
   imshow(~n1);
    ...
    disp(z);
    disp(n);
    save ('/Users/sanjanas/Documents/MATLAB/HWCR1/training_set/featureout.mat','featureout');
    test
    pause(0.5);
end
...
system(['open /Users/sanjanas/Documents/MATLAB/HWCR1/training_set/output.txt']);
...
contents = get(handles.popupmenu5,'String'); 
        train
        helpdlg('Network has been trained using Geometric Feature Extraction technique. Click on "Extract Text" to process the image',...
